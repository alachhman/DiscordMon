const test = {
    ...
    held_items: [
        {
            item: {name: 'big-root', url: 'https://pokeapi.co/api/v2/item/273/'},
            version_details: [
                {
                    rarity: 5,
                    version: {
    ...
    id: 345,
    is_default: true,
    location_area_encounters: 'https://pokeapi.co/api/v2/pokemon/345/encounters',
    moves: [
        {
            move: {
                name: 'swords-dance',
        ...
        {
            move: {name: 'acid', url: 'https://pokeapi.co/api/v2/move/51/'},
            version_group_details: [
                {
                    level_learned_at: 5,
                    move_learn_method: {
